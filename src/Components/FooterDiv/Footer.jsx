    ...
    <div className="footer p-[5rem] mb-4 bg-blueColor rounded-[10px] gap-8 grid grid-cols-5 m-auto items-center justify-center">
      <div>
        ...
        <p className="text-white pb-[13px] opacity-70 leading-7">
          We always make our seekers and companies find the best job and
      ...
      <div>
        ...
        <div>
          ...
          <div className="flex gap-4 py-[1rem]">
            ...
            <AiOutlineTwitter className="bg-white p-[8px] h-[35px] w-[35px] rounded-full fill-blueColor" />
          </div>
        </div>
      </div>
    </div>
